...
# dotenv-merge Rakefile v1.0.0 - 2026-04-03
...
# rake install                                # Build and install dotenv-merge-1.0.0.gem in...
# rake install:local                          # Build and install dotenv-merge-1.0.0.gem in...
# rake kettle:jem:install                     # Install dotenv-merge GitHub automation and ...
# rake kettle:jem:selftest                    # Self-test: template dotenv-merge against itse...
# rake kettle:jem:template                    # Template dotenv-merge files into the curren...
